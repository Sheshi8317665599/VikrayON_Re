...
class CevicesScreen extends StatefulWidget {
  const CevicesScreen({super.key});

  @override
  State<CevicesScreen> createState() => _CevicesScreenState();
}
...
class _CevicesScreenState extends State<CevicesScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: CategoryFeild(
        searchText: "Search",
        socialapplogo: "assets/icons/vonc wathsapp logo crop.png",
        ...
        onVonieTap: (index) => Get.to(() => vonieImageindex(index)),
        ...
        //       onPressedwathasapp: () {},
        //       imageLogo: 'assets/icons/VikrayON_Text_Logo.png',
        //       gradientcolourAppbar: AppColors.appBarColorCvS,
        //       colorsearchBorder: AppColors.bottomNavigationBarColorCvS),
        // ),
