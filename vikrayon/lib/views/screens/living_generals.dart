          ...
          children: [
            SizedBox(
              ...
              child: _isLoading
                  ...
                  : CarouselSlider(
                      items: List.generate(
                        UiHelper.livingGeneralsMainBanners.length,
                        (index) {
                          return InkWell(
                            onTap:
                                //() => getMainBanner(index),
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                      image: AssetImage(
                                        ...
                                        UiHelper
                                            .livingGeneralsMainBanners[index],
                                      ),
                                      fit: BoxFit.fill,
                                    ))),
                          );
                                                ...
                                                child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                      ...
                                                      border: Border.all(
                                                          width: 3,
                                                          color: UiHelper
                                                              .livingGeneralsCategoryColors[0]
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image: AssetImage(//widget.imageFo[index]
                                        UiHelper.livingGeneralsBanners[index]),
                                    fit: BoxFit.fill,
                                  ),
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  Row(
                    children: List.generate(
                      _isLoading ? 6 : UiHelper.livingGeneralsBanners.length,
