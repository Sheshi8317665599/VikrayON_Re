...
class CategoryModel {
 ...
 // final Color colorsearchIcon;
  ...
  //   socialapplogo: json['socialapplogo'] ?? '',
   ...
   //   gradientcolourAppbar: LinearGradient(
   //     colors: (json['gradientcolourAppbar'] as List)
   ...
   //   colorsearchIcon: Color(int.parse(json['colorsearchIcon'] ?? '')),
      ...
      fieldsName: List<String>.from(json['fieldsName'] ?? []),
