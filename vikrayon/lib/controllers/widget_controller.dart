...
//     baseUrl: 'https://ce89-43-230-212-140.ngrok-free.app/products',
...
//     try {
//       isLoading.value = true;
//       final response = await dio.get('/vb-slider/$sliderTag');
...
//   final Dio dio = Dio(
//     BaseOptions(
//       baseUrl: 'https://91da-43-230-212-140.ngrok-free.app/products',
//       connectTimeout: const Duration(seconds: 5),
//       receiveTimeout: const Duration(seconds: 5),
//     ),
//   );
...
//   final Dio dio = Dio(
//     BaseOptions(
//       baseUrl: 'https://3185-43-230-212-140.ngrok-free.app',
//       connectTimeout: const Duration(seconds: 5),
//       receiveTimeout: const Duration(seconds: 5),
//     ),
//   );
